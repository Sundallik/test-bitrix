...
class CIBlockPropertyCProp
{
    ...
    {
        $hideText = Loc::getMessage('MY_COMPLEX_PROP_HIDE_TEXT');
        $clearText = Loc::getMessage('MY_COMPLEX_PROP_CLEAR_TEXT');
        ...
        if(!empty($arProperty['USER_TYPE_SETTINGS'])){
            ...
            return '<span>'.Loc::getMessage('MY_COMPLEX_PROP_ERROR_INCORRECT_SETTINGS').'</span>';
        }
